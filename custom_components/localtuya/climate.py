...
--------------------------------------------------------------------------------
This file has been modified to make a Saswell Tuya Smart Thermostat work with localtuya custom component
original file taken from https://github.com/renat85/localtuya_thermostat/tree/master/localtuya

File needs to be added to the localtuya custom component to add climate support, available from.
https://github.com/rospogrigio/localtuya 

Tested with Saswell Model T19XWHB-7-DF-APP(TY)
Not all functions work, but temperatures read and can be set correctly.
"""
